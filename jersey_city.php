...
<head>
    ...
    <title>Jersey City Forcast</title>
</head>
...
<div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav m-auto">
                        ...
                        <a class="nav-link active" aria-current="page" href="./jersey_city.php">Jersey City</a>
                        <a class="nav-link" href="./princeton.php">Princeton</a>
                        <a class="nav-link" href="./trenton.php">Trenton</a>
    ...
    <h2 class="px-3 py-2">
        Extended Forcast For Jersey City
    </h2>
    <div class="mb-5">
        <table class="table table-info table-striped mb-5" align="center">
            ...
            $query = 'SELECT * FROM JERSEY_CITY_FORCAST';
